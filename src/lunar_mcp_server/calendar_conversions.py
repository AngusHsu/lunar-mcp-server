...
class CalendarConverter:
    ...
    def __init__(self) -> None:
        ...
        self.rat_years = [1900, 1912, 1924, 1936, 1948, 1960, 1972, 1984, 1996, 2008, 2020, 2032]
    ...
    async def solar_to_lunar(self, solar_date_str: str, culture: str = "chinese") -> Dict[str, Any]:
    ...
    async def _solar_to_chinese_lunar(self, solar_date: date) -> Dict[str, Any]:
        """Convert solar date to Chinese lunar date."""
        try:
            result = {"solar_date": solar_date.strftime("%Y-%m-%d"), "culture": "chinese"}

            # Try using specialized libraries first
            if ZHDATE_AVAILABLE:
                try:
                    zh_date = ZhDate.from_datetime(datetime.combine(solar_date, datetime.min.time()))
                    zodiac_info = self._calculate_chinese_zodiac_year(zh_date.lunar_year)
    ...
    async def lunar_to_solar(self, lunar_date_str: str, culture: str = "chinese") -> Dict[str, Any]:
    ...
    async def get_zodiac_info(self, date_str: str, culture: str = "chinese") -> Dict[str, Any]:
    ...
    async def _get_chinese_zodiac_info(self, target_date: date) -> Dict[str, Any]:
        ...
        try:
            ...
            lunar_info = await self.solar_to_lunar(target_date.strftime("%Y-%m-%d"), "chinese")
            ...
            zodiac_traits = {
                "Rat": {"personality": "clever, adaptable, charming", "lucky_colors": ["blue", "gold", "green"], "lucky_numbers": [2, 3]},
                "Ox": {"personality": "reliable, strong, determined", "lucky_colors": ["white", "yellow", "green"], "lucky_numbers": [1, 9]},
                "Tiger": {"personality": "brave, competitive, confident", "lucky_colors": ["orange", "gray", "white"], "lucky_numbers": [1, 3, 4]},
                "Rabbit": {"personality": "gentle, quiet, elegant", "lucky_colors": ["pink", "purple", "blue"], "lucky_numbers": [3, 4, 9]},
                "Dragon": {"personality": "energetic, intelligent, gifted", "lucky_colors": ["gold", "silver", "gray"], "lucky_numbers": [1, 6, 7]},
                "Snake": {"personality": "wise, elegant, intuitive", "lucky_colors": ["black", "red", "yellow"], "lucky_numbers": [2, 8, 9]},
                "Horse": {"personality": "animated, active, energetic", "lucky_colors": ["yellow", "green", "purple"], "lucky_numbers": [2, 3, 7]},
                "Goat": {"personality": "calm, gentle, sympathetic", "lucky_colors": ["green", "red", "purple"], "lucky_numbers": [3, 9, 4]},
                "Monkey": {"personality": "sharp, smart, curious", "lucky_colors": ["white", "gold", "blue"], "lucky_numbers": [1, 8, 7]},
                "Rooster": {"personality": "observant, hardworking, courageous", "lucky_colors": ["gold", "brown", "yellow"], "lucky_numbers": [5, 7, 8]},
                "Dog": {"personality": "lovely, honest, responsible", "lucky_colors": ["green", "red", "purple"], "lucky_numbers": [3, 4, 9]},
                "Pig": {"personality": "honest, generous, reliable", "lucky_colors": ["yellow", "gray", "brown"], "lucky_numbers": [2, 5, 8]}
            }
            ...
            return {
                ...
                "compatibility": {
                    ...
                    "challenging_matches": self._get_zodiac_compatibility(year_animal)["challenging"]
                }
            }
    ...
    def _get_zodiac_compatibility(self, animal: str) -> Dict[str, List[str]]:
        ...
        compatibility_map = {
            "Rat": {"best": ["Dragon", "Monkey", "Ox"], "challenging": ["Horse", "Goat"]},
            "Ox": {"best": ["Snake", "Rooster", "Rat"], "challenging": ["Goat", "Horse"]},
            "Tiger": {"best": ["Horse", "Dog", "Pig"], "challenging": ["Monkey", "Snake"]},
            "Rabbit": {"best": ["Goat", "Pig", "Dog"], "challenging": ["Rooster", "Dragon"]},
            "Dragon": {"best": ["Rat", "Monkey", "Rooster"], "challenging": ["Dog", "Rabbit"]},
            ...
            "Dog": {"best": ["Tiger", "Horse", "Rabbit"], "challenging": ["Dragon", "Rooster"]},
