...
class LunarMCPServer:
            ...
            return [
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "activity": {"type": "string", "description": "Activity type (e.g., wedding, business_opening, travel)"},
                            "culture": {"type": "string", "description": "Cultural tradition (chinese)", "default": "chinese"}
                        },
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "culture": {"type": "string", "description": "Cultural tradition", "default": "chinese"},
                            "limit": {"type": "integer", "description": "Maximum number of dates to return", "default": 10}
                        },
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            "date": {"type": "string", "description": "Date in YYYY-MM-DD format"},
                            "location": {"type": "string", "description": "Location for calculations (lat,lon or city name)", "default": "0,0"}
                        },
                        "required": ["date"]
                    }
                ),
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "year": {"type": "integer", "description": "Year"},
                            "location": {"type": "string", "description": "Location for calculations", "default": "0,0"}
                        },
                        "required": ["month", "year"]
                    }
                ),
                ...
                Tool(
                    ...
                    inputSchema={
                        "type": "object",
                        "properties": {
                            "solar_date": {"type": "string", "description": "Solar date in YYYY-MM-DD format"},
                            "culture": {"type": "string", "description": "Cultural tradition", "default": "chinese"}
                        },
                        "required": ["solar_date"]
                    }
                ...
                Tool(
                    ...
                    inputSchema={
                        "type": "object",
                        "properties": {
                            "lunar_date": {"type": "string", "description": "Lunar date in YYYY-MM-DD format"},
                            "culture": {"type": "string", "description": "Cultural tradition", "default": "chinese"}
                        },
                        "required": ["lunar_date"]
                    }
                ...
                Tool(
                    ...
                    inputSchema={
                        "type": "object",
                        "properties": {
                            "dates": {"type": "array", "items": {"type": "string"}, "description": "Array of dates to compare"},
                            "activity": {"type": "string", "description": "Activity type for comparison"},
                            "culture": {"type": "string", "description": "Cultural tradition", "default": "chinese"}
                        },
                        "required": ["dates"]
                    }
    ...
    async def _check_auspicious_date(self, date: str, activity: str, culture: str = "chinese") -> Dict[str, Any]:
    ...
    async def _find_good_dates(
        self, start_date: str, end_date: str, activity: str,
    ...
    async def _get_daily_fortune(self, date: str, culture: str = "chinese") -> Dict[str, Any]:
    ...
    async def _check_zodiac_compatibility(
        ...
        return await self.auspicious_checker.check_zodiac_compatibility(date1, date2, culture)

    async def _get_lunar_festivals(self, date: str, culture: str = "chinese") -> Dict[str, Any]:
        """Get festivals for a date."""
        return await self.festival_manager.get_festivals_for_date(date, culture)

    async def _get_next_festival(self, date: str, culture: str = "chinese") -> Dict[str, Any]:
        """Get next festival after date."""
        return await self.festival_manager.get_next_festival(date, culture)

    async def _get_festival_details(self, festival_name: str, culture: str = "chinese") -> Dict[str, Any]:
        """Get detailed festival information."""
        return await self.festival_manager.get_festival_details(festival_name, culture)

    async def _get_annual_festivals(self, year: int, culture: str = "chinese") -> Dict[str, Any]:
    ...
    async def _get_moon_calendar(self, month: int, year: int, location: str = "0,0") -> Dict[str, Any]:
    ...
    async def _predict_moon_phases(self, start_date: str, end_date: str) -> Dict[str, Any]:
        """Predict moon phases in date range."""
        return await self.lunar_calc.predict_moon_phases(start_date, end_date)

    async def _solar_to_lunar(self, solar_date: str, culture: str = "chinese") -> Dict[str, Any]:
        """Convert solar to lunar date."""
        return await self.calendar_converter.solar_to_lunar(solar_date, culture)

    async def _lunar_to_solar(self, lunar_date: str, culture: str = "chinese") -> Dict[str, Any]:
        """Convert lunar to solar date."""
        return await self.calendar_converter.lunar_to_solar(lunar_date, culture)

    async def _get_zodiac_info(self, date: str, culture: str = "chinese") -> Dict[str, Any]:
    ...
    async def _batch_check_dates(
        ...
        for date in dates[:30]:  # Limit to 30 dates to prevent abuse
            try:
                check_result = await self.auspicious_checker.check_date(date, activity, culture)
                results.append({
                    "date": date,
        ...
        best_date = max(valid_results, key=lambda x: x["score"]) if valid_results else None
        worst_date = min(valid_results, key=lambda x: x["score"]) if valid_results else None
    ...
    async def _compare_dates(
        self, dates: List[str], activity: str = None, culture: str = "chinese"
    ) -> Dict[str, Any]:
        ...
        for date in dates[:10]:  # Limit to 10 dates for comparison
            try:
                ...
                if activity:
                    auspicious = await self.auspicious_checker.check_date(date, activity, culture)
                ...
                festivals = await self.festival_manager.get_festivals_for_date(date, culture)
                aspects["festivals"] = [f.get("name") for f in festivals.get("festivals", [])]
        ...
        if activity and comparison:
            scores = {d: data.get("score", 0) for d, data in comparison.items() if "score" in data}
            if scores:
    ...
    async def _get_lucky_hours(
        self, date: str, activity: str = None, culture: str = "chinese"
    ) -> Dict[str, Any]:
        ...
        for idx, (time_range, period_name, zodiac_animal) in enumerate(time_periods):
            ...
            if activity:
                ...
                if activity in ["business_opening", "signing_contract"] and idx in [4, 6]:
                    score += 2
            ...
            lucky_hours.append({
                ...
                "score": score,
                "level": level,
                "suitable_for": self._get_suitable_activities(zodiac_animal, activity)
            })
        ...
        return {
            ...
            "best_hours": [h for h in lucky_hours if h["score"] >= 7],
            "daily_overview": daily_fortune
        }

    def _get_suitable_activities(self, zodiac_animal: str, requested_activity: str = None) -> List[str]:
